import { ShippingFormInputs, shippingFormSchema } from "@/Tyeps";
...
const ShippingForm = ({
  ...
  setShoppingForm: (data: ShippingFormInputs) => void;
}) => {
  const {
    register,
    handleSubmit,
  ...
  const hanleShippingForm: SubmitHandler<ShippingFormInputs> = (data) => {
  ...
  return (
    <form
      ...
      onSubmit={handleSubmit(hanleShippingForm)}
    >
