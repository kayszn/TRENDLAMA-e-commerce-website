...
import { CartItemsType, ShippingFormInputs } from "@/Tyeps";
...
const CartPage = () => {
  ...
  const [shippiingForm, setShippiingForm] = useState<ShippingFormInputs>();
      ...
      <div className="w-full flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-7/12 shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8">
          {activeStep === 1 ? (
            ...
            <ShippingForm setShoppingForm={setShippiingForm} />
          ) : activeStep === 3 && shippiingForm ? (
            <PaymentForm />
          ) : (
